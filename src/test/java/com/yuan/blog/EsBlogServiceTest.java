...
//        long totalElements = page.getTotalElements();
    ...
    public void initEsBlog(){
        ...
        esBlogService.save(new EsBlog("2","老卫跟你谈谈 Elasticsearch 的几个用法妹妹",
                "关于如何来用 Elasticsearch，还是得看我的博客 https://waylau.com，妹妹"));  // 关键字"妹"
        esBlogService.save(new EsBlog("3","老卫和你一起学 Elasticsearch",
                "如何来学习 Elasticsearch，最终看我的博客 https://waylau.com，酒")); // 关键字"酒"

        esBlogService.save(new EsBlog("4","03-05 用大白话聊聊分布式系统",
